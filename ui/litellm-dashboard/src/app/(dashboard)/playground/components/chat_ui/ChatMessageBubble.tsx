...
function ChatMessageBubble({
  ...
  return (
    <div className={`mb-4 min-w-0 ${isUser ? "text-right" : "text-left"}`}>
      <div
        className={`inline-block min-w-0 max-w-[92%] overflow-hidden rounded-lg border p-3 text-left shadow-xs sm:max-w-[85%] sm:px-4 ${
          isUser ? "border-info/30 bg-info/10" : "border-border bg-card"
        }`}
      >
